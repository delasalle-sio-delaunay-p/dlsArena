			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-3">
						<h3>Annuler son inscription à un tournoi individuel : </h3>
					...
					-->	  
					    ...
					    <div class="form-group row">
					      <label for="colFormLabel" class="col-sm-2 col-form-label">Inscription : </label>
					      <div class="col-sm-10">
