					...
					<div class="col-lg-10 col-lg-offset-1">
							...
							<div class="panel-body">
								<div class="post">
									<div class="post-header post-author">
										<a href="#" class="author" data-toggle="tooltip" title="YAKUZI"><img src="vues/img/user/avatar.jpg" alt=""></a>
										<div class="post-title">
											<h3><a href="blog-post-slideshow.html">Deadpool Gets the Movie He Deserves</a></h3>
											<ul class="post-meta">
									...
									<div id="post-carousel" class="carousel slide post-thumbnail" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="item active">
												<img src="vues/img/blog/lg/1.jpg" alt="">
												<div class="post-caption">Example of post thumbnail caption</div>
											</div>
											<div class="item">
												<img src="vues/img/blog/lg/2.jpg" alt="">
												<div class="post-caption">Example of post thumbnail caption</div>
											</div>
										</div>
									</div>
						...
						<div class="panel panel-default panel-post">
							<div class="panel-body">
								<div class="post">
									<div class="post-header post-author">
										<a href="#" class="author" data-toggle="tooltip" title="YAKUZI"><img src="vues/img/user/avatar2.jpg" alt=""></a>
										<div class="post-title">
											<h3><a href="blog-post.html">The Witcher 3 is Game of the Year</a></h3>
											<ul class="post-meta">
												<li><a href="#"><i class="fa fa-user"></i> YAKUZI</a></li>
												<li><i class="fa fa-calendar-o"></i> April 13, 2016</li>
												<li><a href="#"><i class="fa fa-comments"></i> 0 <span class="hidden-xs">Comments</span></a></li>
									...
									<div class="post-thumbnail">
										<a href="blog-post.html"><img src="vues/img/blog/lg/3.jpg" alt=""></a>
										<div class="post-caption">Example of post thumbnail caption</div>
									</div>
									Etiam et sollicitudin elit. Sed ultrices aliquet dui, eu aliquet metus sodales sit amet. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Duis porttitor varius pulvinar. Vivamus efficitur vulputate imperdiet.
								</div>
						...
						<div class="panel panel-default panel-post">
							<div class="panel-body">
								<div class="post">
									<div class="post-header post-author">
										<a href="#" class="author" data-toggle="tooltip" title="YAKUZI"><img src="vues/img/user/avatar3.jpg" alt=""></a>
										<div class="post-title">
											<h3><a href="blog-post-video.html">Official Mirror’s Edge Catalyst Trailer</a></h3>
											<ul class="post-meta">
												<li><a href="#"><i class="fa fa-user"></i> YAKUZI</a></li>
												<li><i class="fa fa-calendar-o"></i> April 13, 2016</li>
												<li><a href="#"><i class="fa fa-comments"></i> 0 <span class="hidden-xs">Comments</span></a></li>
							...
							<div class="panel-body">
								<div class="post">
									<div class="post-header post-author">
										...
										<div class="post-title">
											<h3><a href="blog-post-music.html">Batman V Superman Dawn Of Justice Soundtrack</a></h3>
											<ul class="post-meta">
												<li><a href="#"><i class="fa fa-user"></i> YAKUZI</a></li>
												<li><i class="fa fa-calendar-o"></i> April 13, 2016</li>
												<li><a href="#"><i class="fa fa-comments"></i> 0 <span class="hidden-xs">Comments</span></a></li>
									...
									<div class="post-thumbnail">
										<iframe src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/236306876&amp;auto-play=false&amp;hide-related=false&amp;show-comments=true&amp;show-user=true&amp;show-reposts=false&amp;visual=true"></iframe>	
									</div>
									Etiam et sollicitudin elit. Sed ultrices aliquet dui, eu aliquet metus sodales sit amet. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Duis porttitor varius pulvinar. Vivamus efficitur vulputate imperdiet.
								</div>
							</div>
